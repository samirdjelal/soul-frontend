      ...
      <div className="intro-container">
        ...
        <div className="intro-text">
          ...
          <ul className="intro-benefits">
            ...
            <li>
              <i className="fas fa-check" /> 1:1 Founder Diaries video series &amp; community
              events
            </li>
            <li>
              <i className="fas fa-check" /> 1:1 Certifications for your resume and investor decks
            </li>
            <li>
              <i className="fas fa-check" /> 1:1 Access to SOUL’s resources, tools, and networking events
            </li>
          </ul>
